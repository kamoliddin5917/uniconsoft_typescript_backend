...
exports.default = {
    POST: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, name_1, adminId, createOrg, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, name_1 = _a.name, adminId = _a.adminId;
                    if (!name_1)
                        return [2 /*return*/, res.status(400).json({ message: "BAD_REQUEST!" })];
                    return [4 /*yield*/, model_1.default.createOrg(name_1, adminId)];
                case 1:
                    createOrg = _b.sent();
                    if (!createOrg)
    ...
    PUT: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, name_2, adminId, orgId, updateOrg, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, name_2 = _a.name, adminId = _a.adminId;
                    orgId = req.params.orgId;
                    if (!name_2)
                        return [2 /*return*/, res.status(400).json({ message: "BAD_REQUEST!" })];
                    return [4 /*yield*/, model_1.default.updateOrg(name_2, orgId, adminId)];
                case 1:
                    updateOrg = _b.sent();
                    if (!updateOrg)
    ...
    DELETE: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var adminId, orgId, deleteOrg, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    orgId = req.params.orgId;
                    return [4 /*yield*/, model_1.default.deleteOrg(orgId, adminId)];
                case 1:
                    deleteOrg = _a.sent();
                    if (!deleteOrg)

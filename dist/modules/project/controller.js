...
exports.default = {
    POST: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, name_1, orgId, leaderId, createProject, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, name_1 = _a.name, orgId = _a.orgId, leaderId = _a.leaderId;
                    if (!name_1 || !orgId)
                        return [2 /*return*/, res.status(400).json({ message: "BAD_REQUEST!" })];
                    return [4 /*yield*/, model_1.default.createProject(name_1, orgId, leaderId)];
                case 1:
    ...
    PUT: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, name_2, leaderId, projectId, updateProject, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, name_2 = _a.name, leaderId = _a.leaderId;
                    projectId = req.params.projectId;
                    if (!name_2)
                        return [2 /*return*/, res.status(400).json({ message: "BAD_REQUEST!" })];
                    return [4 /*yield*/, model_1.default.updateProject(name_2, projectId, leaderId)];
                case 1:
    ...
    DELETE: function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var leaderId, projectId, deleteProject, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    projectId = req.params.projectId;
                    return [4 /*yield*/, model_1.default.deleteProject(projectId, leaderId)];
                case 1:
